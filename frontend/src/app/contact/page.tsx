  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', maxWidth: '1000px' }}>
          <div>
            <h2 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: '24px' }}>Contact Information</h2>
            {[
              { icon: '📞', label: 'Phone', value: '+91-98993-08683', href: 'tel:+919899308683' },
              { icon: '✉️', label: 'Email', value: 'support@staylo.in', href: 'mailto:support@staylo.in' },
              { icon: '📍', label: 'Address', value: 'New Delhi, India', href: '#' },
              { icon: '⏰', label: 'Support Hours', value: '24/7 Available', href: '#' },
            ].map(info => (
